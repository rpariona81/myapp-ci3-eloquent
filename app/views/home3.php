...
<head>
  ...
  <!-- Favicon -->
  <link rel="shortcut icon" type="image/x-icon" href="<?=base_url('theme/images/favicon.png')?>" />
  
  <!-- PLUGINS CSS STYLE -->
  <link rel="stylesheet" href="<?=base_url('theme/plugins/bootstrap/bootstrap.min.css')?>">
  <link rel="stylesheet" href="<?=base_url('theme/plugins/themify-icons/themify-icons.css')?>">
  <link rel="stylesheet" href="<?=base_url('theme/plugins/slick/slick.css')?>">
  <link rel="stylesheet" href="<?=base_url('theme/plugins/slick/slick-theme.css')?>">
  <link rel="stylesheet" href="<?=base_url('theme/plugins/fancybox/jquery.fancybox.min.css')?>">
  <link rel="stylesheet" href="<?=base_url('theme/plugins/aos/aos.css')?>">
...
<nav class="navbar main-nav navbar-expand-lg px-2 px-sm-0 py-2 py-lg-0">
  <div class="container">
    <a class="navbar-brand" href="index.html"><img src="<?=base_url('theme/images/logo.png')?>" alt="logo"></a>
				...
				<div class="block text-center">
					...
					<ul class="list-inline app-badge">
						...
						<li class="list-inline-item">
							<a href="FAQ.html"><img src="<?=base_url('theme/images/app/appple-store.jpg')?>" alt="Apple Store"></a>
						</li>
						<!-- Google Play -->
						<li class="list-inline-item">
							<a href="FAQ.html"><img src="<?=base_url('theme/images/app/google-play.jpg')?>" alt="Google Play"></a>
						</li>
					</ul>
					<!-- Promo Video -->
					<div class="video">
						<img class="img-fluid shadow" src="<?=base_url('theme/images/thumbs/promo-video-thumbnail.jpg')?>" alt="video-thumbnail">
					...
					<ul class="list-inline clients-logo">
						<!-- Client Logo -->
						<li class="list-inline-item">
							<a href="#"><img src="<?=base_url('theme/images/clients/buzz-feed.png')?>" alt="buzz-feed"></a>
						</li>
						<!-- Client Logo -->
						<li class="list-inline-item">
							<a href="#"><img src="<?=base_url('theme/images/clients/the-new-york-times.png')?>" alt="the-new-york-times"></a>
						</li>
						<!-- Client Logo -->
						<li class="list-inline-item">
							<a href="#"><img src="<?=base_url('theme/images/clients/tech-crunch.png')?>" alt="tech-crunch"></a>
						</li>
						<!-- Client Logo -->
						<li class="list-inline-item">
							<a href="#"><img src="<?=base_url('theme/images/clients/the-washington-post.png')?>" alt="the-washington-post"></a>
						</li>
					</ul>
				</div>
			</div>
		...
		<div class="row">
			<div class="col-lg-12">
				...
				<div class="section-title">
					...
					<p><a href="https://themefisher.com/products/small-apps-free-app-landing-page-template/">Small Apps</a> makes it easy to stay on top of your Life Style.
	...
	<p>Cras ultricies ligula sed magna dictum porta. Cras ultricies ligula sed magna dictum porta. Vivamus</p>
			...
			<div class="col-lg-4 m-auto">
				<div class="app-preview">
					<img src="<?=base_url('theme/images/feature/iphone.jpg')?>" alt="iphone">				
				</div>
			</div>
			<div class="col-lg-4 col-md-6 align-self-center">
				<!-- Service 03 -->
		...
		<div class="row no-gutters">
			<div class="col-lg-6">
				...
				<div class="feature-image left"  data-aos="fade-right">
					<img class="img-fluid" src="<?=base_url('theme/images/feature/iphone-ipad.jpg')?>" alt="iphone-ipad">
				</div>
			</div>
		...
		<div class="row no-gutters">
			...
			<div class="col-lg-6">
				...
				<div class="feature-image right" data-aos="fade-left">
					<img class="img-fluid" src="<?=base_url('theme/images/feature/ipad.jpg')?>" alt="ipad">
				</div>
			</div>
		</div>
	</div>
		...
		<div class="row">
			<div class="col-12">
				...
				<div class="app-explore" data-aos="fade-down">
					<img class="img-fluid" src="<?=base_url('theme/images/feature/ipad-lied.jpg')?>" alt="ipad-lied">
				</div>
			</div>
			<!-- Feature 01-->
...
<footer>
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-4 col-md-12 m-md-auto align-self-center">
          <div class="block">
            <a href="index.html"><img src="<?=base_url('theme/images/logo-alt.png')?>" alt="footer-logo"></a>
            <!-- Social Site Icons -->
  ...
  <script src="<?=base_url('theme/plugins/fancybox/jquery.fancybox.min.js')?>"></script>
  <script src="<?=base_url('theme/plugins/syotimer/jquery.syotimer.min.js')?>"></script>
  <script src="<?=base_url('theme/plugins/aos/aos.js')?>"></script>
  <!-- google map -->
  <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyAgeuuDfRlweIs7D6uo4wdIHVvJ0LonQ6g')?>"></script>
  <script src="<?=base_url('theme/plugins/google-map/gmap.js')?>"></script>
